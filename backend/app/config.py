...
class Config:
    ...
    # Discussion section uses a stronger model for academic-quality writing
    DISCUSSION_LLM_MODEL_NAME = os.environ.get('DISCUSSION_LLM_MODEL_NAME', 'claude-sonnet-4-20250514')
