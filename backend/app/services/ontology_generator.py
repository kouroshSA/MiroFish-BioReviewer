...
suitable for social simulation or biological simulation.
"""
...
**Acceptable entities**:
- Specific individuals (public figures, stakeholders, opinion leaders, experts, scholars, ordinary people)
...
- Representatives of specific groups (e.g., alumni associations, fan groups, activist groups, etc.)
...
A. **Fallback types (must be included, placed as the last 2 in the list)**:
   - `Person`: Fallback type for any individual person. When a person does not fit other more specific person types, they are classified here.
   - `Organization`: Fallback type for any organizational entity. When an organization does not fit other more specific organization types, it is classified here.
...
- The text may contain various people, such as school teachers, bystanders, anonymous netizens
...
4. All entity types must be real-world subjects that can speak out, not abstract concepts
...
"""
    ...
    def _validate_and_process(self, result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Fallback type definitions — always use Person/Organization for ZEP compatibility
        person_fallback = {
            "name": "Person",
