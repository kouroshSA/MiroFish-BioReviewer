...
Inter-process communication between Flask backend and simulation script

Simple command/response pattern via the file system:
    ...
    def send_interview(
        ...
        Args:
            ...
            platform: Specify platform (optional)
                ...
                - None: Interview both platforms in dual-platform mode, or the single platform in single-platform mode
            timeout: Timeout
