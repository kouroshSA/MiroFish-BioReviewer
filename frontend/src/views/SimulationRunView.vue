  ...
  <div class="main-view">
    ...
    <header class="app-header">
      <div class="header-left">
        <div class="brand" @click="router.push('/')">MIROFISH-BIO</div>
      </div>
...
const loadGraph = async (graphId) => {
  // During simulation, auto-refresh skips fullscreen loading to avoid flicker
...
const startGraphRefresh = () => {
  ...
  addLog('Started real-time graph refresh (60s)')
  // 立即刷新一次，然后每60秒刷新 (was 30s, increased for performance on large graphs)
  graphRefreshTimer = setInterval(refreshGraph, 60000)
}
...
onMounted(() => {
  ...
  // Log maxRounds config (value already obtained from query params at init time)
  if (maxRounds.value) {
