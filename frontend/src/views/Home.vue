    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              Even with just a piece of text, <span class=”highlight-bold”>MiroFish</span> can extract real-world seeds from it and automatically generate a parallel world composed of up to <span class=”highlight-orange”>millions of Agents</span>. Inject variables from a god's-eye view to find <span class=”highlight-code”>”local optima”</span> in dynamic environments through complex group interactions.
            </p>
            <p class="slogan-text">
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Enter simulation or prediction requirements in natural language (e.g., What public opinion trends would emerge if a university reverses a disciplinary action?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
