    ...
    <div class="control-bar">
      ...
      <div class="action-controls">
        ...
        >
          ...
          {{ isGeneratingReport ? 'Starting...' : (phase === 1 ? 'Stop & Generate Report Now' : 'Start Generating Report') }}
...
const actionIds = ref(new Set()) // Set of action IDs for dedup
...
const doStartSimulation = async () => {
  ...
  // Reset all state first, ensuring no interference from previous simulation
  resetAllState()
...
// Track each platform's previous round number to detect changes and output logs
